...
INDIR=/lustre/f1/unswept/Steve.Penny/OBS/historical/AVISO
OUTDIR=/lustre/f1/unswept/Steve.Penny/OBS/historical/letkf_fmt/SFC_gerr_ALT
...
# afile=`grep -l $aid $INDIR/*.txt`
  ...
  do
    ...
    #STEVE: there's a gap from 20080807 to 20080818
#   echo "linestr = $linestr"
#   echo "$Y0$M0$D0 -le ${IY}${IM}${ID} && ${IY}${IM}${ID} -le $Y1$M1$D1"
