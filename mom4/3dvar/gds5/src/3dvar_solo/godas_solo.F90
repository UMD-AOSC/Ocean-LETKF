...
!
  ...
  use mpp_mod,                  only: MPP_CLOCK_SYNC !mpp_clock_begin, mpp_clock_end, MPP_CLOCK_SYNC
  use mpp_mod,                  only: MAXPES !MPP_CLOCK_DETAILED, CLOCK_COMPONENT, MAXPES
...
! character(len=50) :: rfile = 'ocean_temp_salt.res.nc'  !STEVE: rfile appeared unused, commented out for now
