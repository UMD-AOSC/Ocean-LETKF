...
real (r14), parameter :: internal_energy_t_exact_ca = 2.499335096217692d-006, cp_t_exact_ca = 2.813976607285440d-009
...
real (r14)  :: gsw_rho_first_derivaties, gsw_cp_t_exact 
...
cp_t_exact = abs(gsw_cp_t_exact(sa,t,p) - 3982.7832563441461d0)
if (cp_t_exact.lt.cp_t_exact_ca) then
  print*; print *, 'gsw_cp_t_exact  ........  passed'
else
  gsw_error_flag = 1;
  print*;
  print*; print *, 'gsw_cp_t_exact  ........  failed'
  print*;
endif
