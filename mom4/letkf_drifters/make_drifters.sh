...
$F90 $OMP $F90_OPT $F90_DEBUG $INLINE $NETCDF_INC $OBJECT_FLAG common_mom4.f90
...
$F90 $OMP $F90_OPT $F90_DEBUG $OBJECT_FLAG $NETCDF_INC common_mpi_mom4.f90
...
$F90 $OMP $F90_OPT $F90_DEBUG $OBJECT_FLAG $NETCDF_INC letkf_drifters_local.o letkf_drifters_tools.f90
$F90 $OMP $F90_OPT $F90_DEBUG $OBJECT_FLAG letkf.f90
#$F90 $OMP $F90_OPT $F90_DEBUG -o ${PGM} *.o $NETCDF_LIB $LBLAS $MPI_LIB
$F90 $OMP $F90_OPT $F90_DEBUG $INLINE -o ${PGM} *.o $MPI_LIB $NETCDF_LIB $LBLAS
