...
!===============================================================================
  ...
  CALL read_fdbk_nc(obsinfile,id_s_obs,obs_data,nobs,0)
  print *, "obsop_ecwmf_sprof.f90:: finished read_fdbk_nc."

  !-----------------------------------------------------------------------------
  ! Read model equivalent from ECMWF NEMOVAR feedback (fdbk) file
  !-----------------------------------------------------------------------------
  print *, "obsop_ecmwf_sprof.f90:: calling read_fdbk_nc for model equivalent..."
  CALL read_fdbk_nc(obsinfile,id_s_obs,hxb_data,nhxb,1)
  print *, "obsop_ecmwf_sprof.f90:: finished read_fdbk_nc."
  ...
  if (nobs .ne. nhxb) then
    print *, "nobs = ", nobs
    print *, "nhbx = ", nhxb
    stop('obsop_ecmwf_sprof.f90:: nobs .ne. nxhb, EXITING...')
  endif
