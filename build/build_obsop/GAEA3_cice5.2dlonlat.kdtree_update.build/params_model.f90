...
!
! 3D Variables:
  INTEGER,PARAMETER :: iv3d_hs=1    ! Snow volume
  INTEGER,PARAMETER :: iv3d_hi=2    ! Ice volume
  INTEGER,PARAMETER :: iv3d_t1=3    ! Surface temp
! INTEGER,PARAMETER :: iv3d_t2=4   
  INTEGER,PARAMETER :: iv3d_ps=4    ! cat-specific Concentration
! 2D Variables:
...
! INTEGER,PARAMETER :: iv4d_z=3                !(OCEAN) (DRIFTERS)
  ...
  CHARACTER(16) :: basefile = 'cice5_model.res.nc'
