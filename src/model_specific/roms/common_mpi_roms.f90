...
CONTAINS
SUBROUTINE set_common_mpi_roms
  ...
  DO j=1,nlat
    DO i=1,nlon
      v3dg(i,j,1,3) = REAL(i,r_sngl)
      v3dg(i,j,2,3) = REAL(j,r_sngl)
    END DO
  END DO
  ...
  RETURN
END SUBROUTINE set_common_mpi_roms
!-----------------------------------------------------------------------
