MODULE gsw_oceanographic_toolbox
!
!
! STEVE: I tried to create a module version of the code supplied by TEOS.
!        Unfortunately, this version had compile errors. So, for now,
!        just include the original file containing all of these loose
!        functions in addition to the 
!

IMPLICIT NONE

PUBLIC :: gsw_sa_from_sp, gsw_ct_from_pt, gsw_t_from_ct
!PUBLIC :: r14, int9
...
!==========================================================================
END MODULE gsw_oceanographic_toolbox
