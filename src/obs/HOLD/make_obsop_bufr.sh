...
#$F90 $OMP $F90_OPT $NETCDF_INC $F90_OBJECT_FLAG read_argo.f90
#$F90 $OMP $F90_OPT $NETCDF_INC $F90_OBJECT_FLAG read_avhrr_pathfinder.f90
#$F90 $OMP $F90_OPT $NETCDF_INC $F90_OBJECT_FLAG read_aviso_adt.f90
$F90 $OMP $F90_OPT $F90_OBJECT_FLAG read_bufr.f90
...
#$F90 $OMP $F90_OPT obsop_bufr_adt.f90   -o ${PGM}.adt.x   *.o $NETCDF_LIB
#$F90 $OMP $F90_OPT obsop_bufr_sst.f90   -o ${PGM}.sst.x   *.o $NETCDF_LIB
