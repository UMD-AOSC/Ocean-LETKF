PROGRAM debug_mom
! STEVE: 
! Because the godas_solo system is producing unexpected (wrong)
! corrections in the output files, I need to check all of the input
! files that are in binary to view them in grads
